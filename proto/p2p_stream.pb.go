...
const (
	...
	ResponseType_MessageTraceMumP2P    ResponseType = 2
...
type HealthResponse struct {
	...
	P2PAddress    string                 `protobuf:"bytes,6,opt,name=p2pAddress,proto3" json:"p2pAddress,omitempty"`
	Country       string                 `protobuf:"bytes,7,opt,name=country,proto3" json:"country,omitempty"`
	CountryIso    string                 `protobuf:"bytes,8,opt,name=country_iso,json=countryIso,proto3" json:"country_iso,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_p2p_stream_proto_rawDesc = "" +
	...
	"\n" +
	"ListTopics\x12\v.proto.Void\x1a\x10.proto.TopicList\"\x00B.Z,github.com/getoptimum/mump2p-cli/proto;protob\x06proto3"
